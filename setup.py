...
NAME = 'pyconsem'
DESCRIPTION = 'Py Project to perform data conversion using semantics and knowledge-graphs'
URL = 'https://github.com/vliz-be-opsci/pyConSem'
EMAIL = 'marc.portier@gmail.com'
AUTHOR = 'Marc Portier'
LICENSE = 'MIT'
CONSOLE_SCRIPTS = ['pyconsem = pyconsem.__main__:main']
TROVE_CLASSES = [
    # Trove classifiers
